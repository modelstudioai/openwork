...
This trademark policy governs the use of the "Craft" and "Qwen Code" names, logos, and branding in connection with the Qwen Code open source project.
...
- The Qwen Code logo and icon

## What You Can Do

### Use the Code Freely

The Qwen Code source code is licensed under the Apache License 2.0. You are free to:
...
- "Based on Qwen Code"
- "Built with Qwen Code technology"
- "Compatible with Qwen Code"
- "Fork of Qwen Code"

### Contribute to the Project

Contributors to the official Qwen Code repository may use the trademarks when discussing their contributions.
...
- Use "Craft" or "Qwen Code" as your product name
...
- Could cause confusion between your product and the official Qwen Code
- Disparages Craft Docs Ltd. or the Qwen Code project
...
- "MyAgent - based on Qwen Code"
- "This project is a fork of Qwen Code"
- "Compatible with the Qwen Code ecosystem"
