...
import openWorkSymbol from '../../assets/openwork-symbol.png';
...
function IconOpenWorkLogo() {
  return <img className={styles.openWorkLogo} src={openWorkSymbol} alt="" />;
}
