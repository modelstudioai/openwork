...
export const RPC_CHANNELS = {
  ...
  sessions: {
    GET: 'sessions:get',
    GET_FOR_WORKSPACE: 'sessions:getForWorkspace',
    ...
    LIST_CHANGED: 'sessions:listChanged',
    LIST_REFRESH_STATE_CHANGED: 'sessions:listRefreshStateChanged',
  ...
  window: {
    ...
    BEGIN_DRAG: 'window:beginDrag',
    MOVE_DRAG: 'window:moveDrag',
  ...
  settings: {
    ...
    LIST_QWEN_PROVIDERS: 'settings:listQwenProviders',
  ...
  browserPane: {
    ...
    TOGGLE_DOCK_EXPANDED: 'browser-pane:toggle-dock-expanded',
